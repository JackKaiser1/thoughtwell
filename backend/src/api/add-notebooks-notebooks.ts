...
import { getNotebook, makeChildNotebook } from "../db/queries/notebooks.js";
...
export async function handlerAddNotebooksToNotebook(req: Request, res: Response) {
    ...
    const authorizedPayload = await verifyChildrenToAdd(db, req.body, authenticatedUserId, getNotebook);
